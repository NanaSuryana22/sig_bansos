            ...
            <table class="table table-bordered table-striped table-condensed cf">
              <thead class="cf">
                <tr>
                  ...
                  <th>Desa</th>
                  <th>Quota</th>
                  <th>Status Ke Kecamatan</th>
                  <th>Status Ke Desa</th>
                  <th>Keterangan</th>
              ...
              <tbody>
                @foreach($penyaluran as $no => $b)
                  <tr>
                    ...
                    <td class="numeric" data-title="Status Penyaluran Kecamatan">{{ $b->status_tracking_kecamatan }}</td>
                    <td class="numeric" data-title="Status Penyaluran Desa">{{ $b->status_tracking_desa }}</td>
                    ...
                    <td class="numeric" data-title="Aksi">
                      <form action="{{ route('penyaluran.destroy', $b->id) }}" method="post">
                        ...
                        @if($b->status_tracking_kecamatan == 'Dalam Proses')
                          <a class="btn btn-primary btn-xs"
