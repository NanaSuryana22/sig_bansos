        ...
        <div class="panel-body">
          <div class="tab-content">
            ...
            <div id="laporan">
              ...
              <br />
              @if ($pelaporan->status_desa == 'Dalam Proses Verifikasi' && $pelaporan->desa_id == $desa_user[0])
                <button class="btn btn-warning btn-md" title="Tindak Lanjut Laporan Ini ?" data-toggle="modal" data-target="#approval_desa">
                  <i class="fa fa-check"></i>
                </button>
                @include('laporan_tingkat_desa.approval_kel')
              @endif
              <a href="{{ route('laporan_tingkat_desa.index')  }}" class="pull-right btn btn-primary btn-md">
