<div class="modal fade" id="approval_kemensos" tabindex="-1" role="dialog" aria-labelledby="approval_kemensos" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal style-form" action="{{ route('laporan_tingkat_kemensos.update', $b->id) }}" method="post">
